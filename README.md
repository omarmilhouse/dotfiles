...
```bash
git clone https://github.com/omarmilhouse/dotfiles.git && cd dotfiles && source bootstrap.sh
```
...
You could also use `~/.extra` to override settings, functions and aliases from my dotfiles repository. It’s probably better to [fork the parent repository](https://github.com/mathiasbynens/dotfiles/fork) instead, though.
